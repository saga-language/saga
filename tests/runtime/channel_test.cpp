...
TEST(ChannelTest, NewAndDestroy) {
  mc_channel *ch = saga_channel_new(sizeof(int64_t), 8);
...
TEST(ChannelTest, NewDefaultCapacity) {
  mc_channel *ch = saga_channel_new(sizeof(int64_t), 0);
  ASSERT_NE(ch, nullptr);
  saga_channel_close(ch);
  saga_channel_destroy(ch);
}
...
TEST(ChannelTest, FIFO_Order) {
  mc_channel *ch = saga_channel_new(sizeof(int64_t), 16);
...
TEST(ChannelTest, LargerElements) {
  ...
  mc_channel *ch = saga_channel_new(sizeof(Payload), 4);
...
TEST(ChannelTest, WrapAround) {
  ...
  mc_channel *ch = saga_channel_new(sizeof(int64_t), 4);
...
TEST(ChannelTest, SendBlocksWhenFull) {
  mc_channel *ch = saga_channel_new(sizeof(int64_t), 2);
...
TEST(ChannelTest, CloseUnblocksSend) {
  mc_channel *ch = saga_channel_new(sizeof(int64_t), 1);
